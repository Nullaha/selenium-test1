...
# 更改链接txt处！！！！
file = open("D:\\Documents\Desktop\经济普查\交通运输.txt","r")
...
headers = {'User-Agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.102 Safari/537.36',
            'Cookie': 'JSESSIONID=A2BECBC8824C6A2FE4FF929A1780CB4C',
...
for n in range(14,102):
    driver = webdriver.Chrome('C:\Program Files (x86)\Google\Chrome\Application\chromedriver.exe')
    driver.get(sites[n-1])
    time.sleep(4)


    #获取title
    titlea = driver.find_element_by_css_selector("div.item_name_view > span").text
    #get_attribute('textContent')
    title = titlea + str(n-1)
    print(title)
    titles.append(title)
    ...
    #print(ii[-1])
    iii ='http://www.china-data-online.com/CensusMaps/RequestExport?exportType=png&mapID='+ sites_code[n-1]+'&imagePath=cache/widget/staticMap/'+ii[-1]+'&mapTitle='
    print(iii)
    ...
    #更改images保存处！！！！！
    local = 'D://Documents/Desktop/images/交通运输9/'
